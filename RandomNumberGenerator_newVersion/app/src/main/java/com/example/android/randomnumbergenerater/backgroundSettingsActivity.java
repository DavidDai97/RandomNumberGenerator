    ...
    protected void onCreate(Bundle savedInstanceState) {
	    ...
	    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
		    ...
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			    ...
			    editor.putInt("Background", currentImage.getmImageResourceId());
			    editor.commit();
			    Toast.makeText(backgroundSettingsActivity.this, "设置完成！", Toast.LENGTH_SHORT).show();
	    ...
	    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
		    ...
		    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			    Images currentImage = (Images) parent.getItemAtPosition(position);
			    Intent setBackground = new Intent(backgroundSettingsActivity.this, MainActivity.class);
			    SettingResource resource = new SettingResource(currentImage.getmImageResourceId(), "background");
